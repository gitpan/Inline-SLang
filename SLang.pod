...
=head3 But all I want to do is use this S-Lang module?
...
- version 0.11 does not include such support -
...
(i.e. the L<Perl Data Language|PDL> support that is
I<not yet> available). This routine is more useful for arrays of
