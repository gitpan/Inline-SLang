...
B<Note:> There is no PDL support as of version 0.12 of
C<Inline::SLang>; we are getting closer to such support however.
...
The only tested operating systems are Solaris and Linux.
This will hopefully extend to Alpha and Mac OS X machines in the
near future. It should compile on UNIX-like systems (no promises
