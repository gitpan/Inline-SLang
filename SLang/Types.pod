...
I promise that soon (not many more releases after v0.11)
...
Actually, the support for piddles is
not-yet available (version 0.11).
...
as the output of C<< DataaType_Type->new() >> can.
